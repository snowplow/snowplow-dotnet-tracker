...
The Snowplow Dotnet Tracker is maintained by the Engineering team at Snowplow Analytics. We welcome suggestions for improvements and bug fixes to all Snowplow Trackers.  
...
[the issues labeled `good first issue`](https://github.com/snowplow/snowplow-dotnet-tracker/labels/good%20first%20issue).
